        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="mx-auto">
                <div class="flex justify-between items-center py-4">
                    <a href="#" class=" tracking-wide font-bold rounded border-2 border-blue-500 hover:border-blue-500 bg-blue-500 text-white hover:bg-blue-600 transition shadow-md py-1 px-6 items-center">Take a New Quiz</a>
                        ...
                        <div class="flex flex-wrap -m-4 text-center">
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full ">
                                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg bg-white">
                                    ...
                                    <h2 class="title-font font-medium text-xl text-gray-900">{{ $total }}</h2>
                                    <p class="leading-relaxed">Topics</p>
                                </div>
                            </div>
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full ">
                                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg bg-white">
                                    ...
                                    <h2 class="title-font font-medium text-xl text-gray-900">{{ $questions }}</h2>
                            ...
                            <div class="p-4 md:w-1/4 sm:w-1/2 w-full ">
                                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg bg-white">
                                    ...
                                    <h2 class="title-font font-medium text-xl text-gray-900">1</h2>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="capitalize bg-white divide-y divide-gray-200">
                                        <tr class="hover:bg-green-100">
                                                ...
                                                <div class="flex items-center">
                                                    <div class="ml-4">
                                                        <div class="text-sm font-medium text-gray-900">
                                                            <a class="text-white px-6 font-extrabold py-1 rounded-lg bg-blue-500 hover:bg-blue-600 hover:underline" href="#">
                                                                test
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <td class="px-6 py-1">
                                                <div class="text-sm text-gray-900">Completed</div>
                                            </td>
                                            <td class="px-6 py-1">
                                                <div class="text-sm ">
                                                    <progress class="max-w-full  mx-auto mr-1 " id="1" value="80" max="100"> 80 </progress> <span> 80% </span>
                                                </div>
                                            </td>
                                            <td class="px-6 py-1">
                                                <div class="text-sm text-gray-900">22/1/2023</div>
                                            </td>
