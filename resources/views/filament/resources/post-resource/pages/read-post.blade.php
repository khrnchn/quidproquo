                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            <img class="mr-4 w-16 h-16 rounded-full" src="{{ asset('storage/' . $post->author->photo) }}" alt="Author">
                            <div>
                                ...
                                <p class="text-base font-light text-gray-500 dark:text-gray-400">
                                    <time>{{ \Carbon\Carbon::parse($post->published_at)->format('j F Y') }}</time>
                                </p>
                            </div>
                        </div>
                    </address>
                    ...
                    <figure class="mt-8 mb-4">
                        <div class="border border-gray-300 rounded-lg overflow-hidden">
                            <img class="mx-auto" src="{{ asset('storage/' . $post->banner) }}" alt="Post Banner" style="max-width: 100%; max-height: 400px;">
                        </div>
                    </figure>
                    @endif
